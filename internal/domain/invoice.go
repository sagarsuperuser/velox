...
type Invoice struct {
	...
	// SourcePlanChangedAt, when set, identifies this invoice as a proration
	// artifact generated by a subscription plan change at the given moment.
	// Combined with TenantID + SubscriptionID, it is the natural key used to
	// dedup retries of proration generation — see migration 0005.
