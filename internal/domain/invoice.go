...
type Invoice struct {
	...
	// SourcePlanChangedAt + SourceSubscriptionItemID, when set, identify this
	// invoice as a proration artifact generated by an immediate plan change on
	// a specific item. Combined with TenantID + SubscriptionID they form the
	// natural key used to dedup retries of proration generation (see migration
	// 0026 — the item id disambiguates simultaneous changes to different items
	// that share a wall-clock timestamp).
