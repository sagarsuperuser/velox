...
function EditBillingProfileModal({ customerId, profile, onClose, onSaved }: {
  ...
  return (
    <Modal open onClose={onClose} title="Billing Profile" wide>
      <form onSubmit={handleSubmit} noValidate className="max-h-[70vh] overflow-y-auto -mx-6 px-6">
        {/* Contact Information */}
        <div className="pb-5">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Contact Information</p>
        ...
        <div className="py-5 border-t border-gray-100">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Address</p>
          <div className="space-y-3">
            <FormField label="Street Address" value={form.address_line1} maxLength={200} placeholder="123 Main Street"
              onChange={e => setForm(f => ({ ...f, address_line1: e.target.value }))} />
            <FormField label="Apt, Suite, etc." value={form.address_line2} maxLength={200} placeholder="Suite 100"
        ...
        {/* Tax & Billing */}
        <div className="py-5 border-t border-gray-100">
          <p className="text-xs font-medium text-gray-400 uppercase tracking-wider mb-3">Tax & Billing</p>
          <div className="grid grid-cols-2 gap-4">
            <FormField label="Tax ID (VAT / EIN / GST)" value={form.tax_identifier} maxLength={30} placeholder="US12-3456789" mono
