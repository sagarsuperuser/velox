...
export function SettingsPage() {
  ...
  const fieldClass = "w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-velox-500"
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="flex justify-end mt-6">
          <button type="submit" disabled={saving}
            className="px-6 py-2 bg-velox-600 text-white rounded-lg text-sm font-medium hover:bg-velox-700 disabled:opacity-50 transition-colors">
